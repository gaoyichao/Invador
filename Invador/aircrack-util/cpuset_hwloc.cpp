...
ac_cpuset_t *ac_cpuset_new(void) { return (ac_cpuset_t *)malloc(sizeof(struct ac_cpuset)); }
...
void ac_cpuset_distribute(ac_cpuset_t *cpuset, size_t count)
{
    ...
    cpuset->hwloc_cpusets = (hwloc_cpuset_t*)calloc(count, sizeof(hwloc_cpuset_t));
