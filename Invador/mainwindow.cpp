...
MainWindow::MainWindow(ByNetEngine &engine, QWidget *parent) :
    m_engine(engine),
    QMainWindow(parent),
    ui(new Ui::MainWindow)
{
    ...
    m_engine.ClearDevs();
    m_engine.UpdateDevs();
    ByNetInterface *monitor = m_engine.FindMonitorInterface();
    if (NULL == monitor) {
        monitor = m_engine.AddInterface("douniwan");
    }
...
MainWindow::~MainWindow()
{
    ...
    m_engine.DelInterface("douniwan");
}
